...
class LSTM:
    ...
    def prediction(self):
        ...
        weights = {
            'out': init_weights([self.number_hidden, number_outputs], "weights_out")
        }
        biases = {
        ...
        lstm_cell = rnn_cell.LSTMCell(self.number_hidden, forget_bias=1.0, state_is_tuple=True)
        lstm_cell = rnn_cell.MultiRNNCell([lstm_cell] * self.number_layers, state_is_tuple=True)
